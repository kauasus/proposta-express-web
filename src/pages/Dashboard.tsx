...
export const DashboardPage = () => {
  ...
  const totalRevenue = proposals.reduce(
    (acc, proposal) => acc + proposal.total,
    0,
  )
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Dashboard"
        description="Acompanhe tudo que está acontecendo no seu funil de vendas."
      />
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <p className="max-w-2xl text-sm leading-6 text-white/70 sm:text-base">
                Veja quantas propostas estão no ar, quanto você já tem garantido
      ...
      <section className="grid gap-6 xl:grid-cols-[1.15fr,0.85fr]">
        <Card className="border-border/60 bg-card/90 shadow-lg shadow-slate-900/5 backdrop-blur-sm">
          <CardHeader className="flex flex-row items-start justify-between gap-4">
            <div>
              ...
              <CardDescription>
                Como estão suas propostas agora.
              </CardDescription>
            </div>
          ...
          <CardContent className="space-y-4">
            {statusConfig.map(({ key, label, color }) => {
              ...
              const percentage = proposals.length
                ? Math.round((count / proposals.length) * 100)
                : 0
        ...
        <Card className="border-border/60 bg-card/90 shadow-lg shadow-slate-900/5 backdrop-blur-sm">
          <CardHeader>
            ...
            <CardDescription>
              Faça o que importa em poucos cliques.
            </CardDescription>
          </CardHeader>
      ...
      <Card className="border-border/60 bg-card/90 shadow-lg shadow-slate-900/5 backdrop-blur-sm">
        <CardHeader className="flex flex-row items-start justify-between gap-4">
          <div>
            ...
            <CardDescription>
              Acompanhe suas propostas mais recentes e retome o trabalho com
              contexto.
            </CardDescription>
          </div>
          <Button
