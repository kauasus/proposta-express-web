...
import { Building2, CircleDollarSign, Download, FileText, Layers3, Plus, Printer, ShieldCheck, Sparkles, Trash2 } from 'lucide-react'
...
const updateHighlight = (
  ...
  const highlights = [...current.highlights] as ProposalPdfBranding['highlights']
...
export const ProposalEditorPage = () => {
  ...
  const [branding, setBranding] = useState<ProposalPdfBranding>(pdfBrandingDefaults)
  ...
  const pdfDocumentData = useMemo(
    ...
    [branding, loadedProposal, selectedClient, subtotal, total, watchedDiscount, watchedItems, watchedNotes, watchedTitle, watchedValidUntil],
  )
  ...
  const updateBranding = <K extends keyof ProposalPdfBranding>(field: K, value: ProposalPdfBranding[K]) => {
  ...
  return (
    <div className='space-y-6'>
      <PageHeader
        ...
        description='Monte a proposta com cálculo em tempo real e um PDF profissional, com identidade visual da empresa.'
      />
      ...
      <div className='grid gap-6 xl:grid-cols-[1.05fr,0.95fr]'>
        <div className='space-y-6'>
          <Card>
            <CardHeader>
              ...
              <CardDescription>Organize o orçamento antes de gerar o PDF.</CardDescription>
            </CardHeader>
            <CardContent>
              <form className='space-y-5' onSubmit={form.handleSubmit(onSubmit)}>
                  ...
                  <div className='flex items-center justify-between gap-4'>
                    <div>
                      ...
                      <p className='text-sm text-muted-foreground'>
                        Adicione serviços, produtos e valores com totalização automática.
                      </p>
                    </div>
                    <Button
                      type='button'
                ...
                <Card className='border-dashed border-border/70 bg-muted/20'>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Personalize a apresentação comercial da proposta. Esses dados podem depois vir da API ou das configurações da empresa.
                    </CardDescription>
                  </CardHeader>
                  <CardContent className='space-y-5'>
                    <div className='grid gap-4 md:grid-cols-2'>
                      <div className='space-y-2'>
                        ...
                        <Input value={branding.brandName} onChange={(event) => updateBranding('brandName', event.target.value)} />
                      </div>
                      <div className='space-y-2'>
                        <Label>Razão social</Label>
                        <Input value={branding.legalName} onChange={(event) => updateBranding('legalName', event.target.value)} />
                      </div>
                    </div>
                    ...
                    <div className='grid gap-4 md:grid-cols-2'>
                      ...
                      <div className='space-y-2'>
                        <Label>Slogan</Label>
                        <Input value={branding.slogan ?? ''} onChange={(event) => updateBranding('slogan', event.target.value)} />
                      </div>
                    </div>
                    ...
                    <div className='grid gap-4 md:grid-cols-2'>
                      <div className='space-y-2'>
                        <Label>CNPJ</Label>
                        <Input value={branding.cnpj ?? ''} onChange={(event) => updateBranding('cnpj', event.target.value)} />
                      </div>
                      <div className='space-y-2'>
                        <Label>Website</Label>
                        <Input value={branding.website ?? ''} onChange={(event) => updateBranding('website', event.target.value)} />
                      </div>
                    </div>
                    ...
                    <div className='grid gap-4 md:grid-cols-2'>
                      <div className='space-y-2'>
                        ...
                        <Input value={branding.email ?? ''} onChange={(event) => updateBranding('email', event.target.value)} />
                      </div>
                      <div className='space-y-2'>
                        <Label>Telefone comercial</Label>
                        <Input value={branding.phone ?? ''} onChange={(event) => updateBranding('phone', event.target.value)} />
                      </div>
                    </div>
                    ...
                    <div className='grid gap-4 md:grid-cols-2'>
                      <div className='space-y-2'>
                        ...
                        <Input value={branding.address ?? ''} onChange={(event) => updateBranding('address', event.target.value)} />
                      </div>
                      <div className='space-y-2'>
                        <Label>Cidade / UF</Label>
                        <Input value={branding.cityState ?? ''} onChange={(event) => updateBranding('cityState', event.target.value)} />
                      </div>
                    </div>
                    ...
                    <div className='grid gap-4 md:grid-cols-3'>
                      <div className='space-y-2'>
                        ...
                        <Input
                          ...
                          onChange={(event) => setBranding((current) => updateHighlight(current, 0, event.target.value))}
                        />
                      </div>
                      <div className='space-y-2'>
                        ...
                        <Input
                          ...
                          onChange={(event) => setBranding((current) => updateHighlight(current, 1, event.target.value))}
                        />
                      </div>
                      <div className='space-y-2'>
                        ...
                        <Input
                          ...
                          onChange={(event) => setBranding((current) => updateHighlight(current, 2, event.target.value))}
                        />
                      </div>
                    </div>
                    ...
                    <div className='grid gap-4 md:grid-cols-2'>
                      <div className='space-y-2'>
                        ...
                        <Input
                          ...
                          onChange={(event) => updateBranding('deliveryEstimate', event.target.value)}
                        />
                      </div>
                      <div className='space-y-2'>
                        ...
                        <Input
                          ...
                          onChange={(event) => updateBranding('paymentTerms', event.target.value)}
                        />
                      </div>
                    </div>
                    ...
                    <div className='grid gap-4 md:grid-cols-2'>
                      <div className='space-y-2'>
                        ...
                        <textarea
                          ...
                          onChange={(event) => updateBranding('confidentialityNote', event.target.value)}
                        />
                      </div>
                      <div className='space-y-2'>
                        ...
                        <textarea
                          ...
                          onChange={(event) => updateBranding('guaranteeNote', event.target.value)}
                        />
                      </div>
                    </div>
                    ...
                    <div className='grid gap-4 md:grid-cols-2'>
                      <div className='space-y-2'>
                        ...
                        <Input value={branding.signatureName} onChange={(event) => updateBranding('signatureName', event.target.value)} />
                      </div>
                      <div className='space-y-2'>
                        <Label>Cargo / assinatura</Label>
                        <Input value={branding.signatureRole} onChange={(event) => updateBranding('signatureRole', event.target.value)} />
                      </div>
                    </div>
                  </CardContent>
                </Card>
        ...
        <Card className='xl:sticky xl:top-28'>
          <CardHeader>
            ...
            <CardDescription>
              Pré-visualização da proposta com layout comercial, identidade visual e dados persuasivos.
            </CardDescription>
          </CardHeader>
          <CardContent className='space-y-4'>
            <div className='rounded-3xl border border-border/70 bg-muted/20 p-4'>
              ...
              <div className='mt-4 grid gap-3 sm:grid-cols-2'>
                ...
                <div className='flex items-center justify-center rounded-xl border border-border/70 bg-background px-4 py-2.5 text-sm text-muted-foreground'>
                  <ShieldCheck className='mr-2 h-4 w-4' />
                  Modelo seguro e preparado para evoluir com a API
                </div>
              </div>
            </div>
