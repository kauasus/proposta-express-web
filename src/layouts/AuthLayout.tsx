        ...
        <div className='rounded-[1.5rem] border border-border/60 bg-background/80 p-6 sm:p-8'>
          <div className='mb-6 flex items-center justify-between'>
            <div className='flex items-center gap-3'>
              ...
              <div>
                <p className='text-xs font-semibold uppercase tracking-[0.22em] text-muted-foreground'>Bem-vindo</p>
                <p className='text-sm font-medium text-foreground'>Proposta Express</p>
              </div>
            </div>
