...
export const EmptyState = ({ icon: Icon, title, description, ctaLabel, onCtaClick }: EmptyStateProps) => (
  <div className='flex flex-col items-center justify-center rounded-3xl border border-dashed border-border/70 bg-card/70 px-6 py-14 text-center shadow-lg shadow-slate-900/5 backdrop-blur-sm'>
    ...
    <p className='mb-5 mt-2 max-w-md text-sm leading-6 text-muted-foreground'>{description}</p>
    {ctaLabel && onCtaClick ? (
