...
export const SelectContent = ({ className, children, ...props }: SelectPrimitive.SelectContentProps) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content className={cn('z-50 min-w-[8rem] rounded-2xl border border-border/70 bg-popover/95 p-1.5 shadow-2xl shadow-slate-900/10 backdrop-blur-md', className)} {...props}>
